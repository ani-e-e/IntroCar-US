...
export const tenants = {
  ...
  // Albers RB - German reseller
  'albers-rb': {
    name: 'Albers RB',
    slug: 'albers-rb',
    domain: 'albers.introcar.com',
    colors: {
      primary: '#8B0000',      // Dark red (from albersrb.com)
      primaryDark: '#6B0000',  // Darker red
      accent: '#FFD700',       // Gold
      accentLight: '#FFE44D',  // Light gold
      secondary: '#A52A2A',    // Brown-red
      background: '#faf8f5',   // Warm white
      text: '#1a1a1a',         // Near black
      textLight: '#666666',    // Medium gray
    },
    logo: null,                // Uses default or can be customized
    skuFilter: 'reseller_albers',
    orderEmail: 'orders@albersrb.com',
    features: ['light'],
    showPrices: false,         // Light sites don't show prices
    showCart: false,           // Light sites use email ordering
    checkoutEnabled: false,
    companyInfo: {
      name: 'Albers RB',
      phone: null,
      email: 'orders@albersrb.com',
      address: 'Germany',
    }
  },
