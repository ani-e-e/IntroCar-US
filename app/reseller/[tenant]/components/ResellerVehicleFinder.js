...
export default function ResellerVehicleFinder({ tenantSlug }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            style={{
              backgroundColor: chassisLookupMode ? primaryColor : 'white',
              color: chassisLookupMode ? 'white' : primaryColor,
      ...
      {/* Chassis Lookup Mode */}
      {chassisLookupMode ? (
        <div className="rounded-lg p-6" style={{ backgroundColor: `${primaryColor}08` }}>
            ...
            <div className="flex-1 w-full md:w-auto">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 font-mono text-lg tracking-wider"
                    ...
                    <div className="grid gap-2">
                      {chassisLookupResult.matches.map((match, idx) => (
                        <button
                          ...
                          className="text-left p-3 bg-white rounded border border-gray-200 hover:bg-gray-50 transition-colors"
        ...
        <>
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="shrink-0">
              <h2 className="text-lg font-display font-light text-gray-900">Find Parts for Your Vehicle</h2>
          ...
          {showChassisInput && selectedMake && selectedModel && (
            <div
              className="flex flex-col md:flex-row md:items-center gap-3 pl-0 md:pl-[220px] p-4 rounded-lg"
              style={{ backgroundColor: `${primaryColor}08` }}
            >
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <Info className="w-4 h-4 shrink-0" style={{ color: primaryColor }} />
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={chassisInput}
                  onChange={(e) => setChassisInput(e.target.value.toUpperCase().trim())}
                  className="w-32 px-4 py-2 border border-gray-300 rounded-lg text-center font-mono focus:outline-none focus:ring-2"
                  style={{ '--tw-ring-color': primaryColor }}
                  maxLength={10}
                />
                {chassisValidation && (
